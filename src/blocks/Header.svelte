...
<header
	class="fixed left-0 top-0 z-50 flex max-h-24 w-full flex-wrap border-b border-gray-200 bg-white py-1 shadow-md dark:border-neutral-700 dark:bg-neutral-800 sm:flex-nowrap sm:justify-start md:flex-nowrap md:justify-start{clazz
		? ` ${clazz}`
		: ''}"
>
	<nav
